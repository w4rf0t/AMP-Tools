...
- Đầu tiên, bạn cần sử dụng lệnh `git clone https://github.com/w4rf0t/recon_tool ; cd recon_tool ; chmod +x AutoRecon/install.sh` để cài các **_requirements_** cần thiết cho chương trình
